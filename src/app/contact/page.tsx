...
export default function Contact() {
  ...
  return (
    <div className="container max-w-7xl mx-auto md:py-12 py-3 md:px-15 px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary">Kuningan, Kel Windusengkahan</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        {/* Contact Form */}
        <motion.div
          className="bg-gray-50 dark:bg-dark/50 p-6 rounded-lg shadow-md mb-8"
          {...slideInRight}
        >
          <motion.form
